...
_reactDom2['default'].render(_react2['default'].createElement(_componentsMain2['default'], null), document.getElementById('main'));

},{"./components/Main":164,"react":158,"react-dom":2}],160:[function(require,module,exports){
"use strict";
...
exports["default"] = _react2["default"].createClass({
  ...
  render: function render() {
    return _react2["default"].createElement(
      ...
      _react2["default"].createElement("img", { src: this.props.item.imgSrc, alt: this.props.item.name }),
      _react2["default"].createElement(
        "p",
        null,
...
var _BasicItem = require('./BasicItem');

var _BasicItem2 = _interopRequireDefault(_BasicItem);

var _ImgSrcItem = require('./ImgSrcItem');

var _ImgSrcItem2 = _interopRequireDefault(_ImgSrcItem);
    ...
    return _react2['default'].createElement(
      ...
      this.props.currentTab == 1 ? _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'h2',
          null,
          _Data2['default'].teamTabs[0].heading
        ),
        _Data2['default'].teamMembers.map(function (item, index) {
          return _react2['default'].createElement(_BasicItem2['default'], { item: item, key: index });
        })
      ) : null,
      this.props.currentTab == 2 ? _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'h2',
          null,
          _Data2['default'].teamTabs[1].heading
        ),
        _Data2['default'].organizations.map(function (item, index) {
          return _react2['default'].createElement(_BasicItem2['default'], { item: item, key: index });
        })
      ) : null,
      this.props.currentTab == 3 ? _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'h2',
          null,
          _Data2['default'].teamTabs[2].heading
        ),
        _Data2['default'].imageCredits.map(function (item, index) {
          return _react2['default'].createElement(_ImgSrcItem2['default'], { item: item, key: index });
        })
      ) : null
    );
  }
...
},{"./BasicItem":160,"./Data":162,"./ImgSrcItem":163,"react":158}],162:[function(require,module,exports){
"use strict";
...
exports["default"] = _react2["default"].createClass({
  displayName: "ImgSrcItem",

  render: function render() {
    return _react2["default"].createElement(
      "figure",
      null,
      _react2["default"].createElement("img", { src: this.props.item.imgSrc, alt: this.props.item.description }),
      _react2["default"].createElement(
        "figcaption",
        { className: "imgSrcDescription" },
        this.props.item.description
      )
    );
  }
...
},{"./Content":161,"./Tabs":165,"react":158}],165:[function(require,module,exports){
'use strict';
...
exports['default'] = _react2['default'].createClass({
  ...
  render: function render() {
    ...
    return _react2['default'].createElement(
      'nav',
      { className: 'sub-nav' },
      _Data2['default'].teamTabs.map((function (tab, index) {
        return _react2['default'].createElement(
          'button',
          { type: 'button', key: index, onClick: _this.handleClick.bind(_this, tab), className: _this.props.currentTab === tab.id ? 'active' : null },
          _react2['default'].createElement(
            'span',
            null,
            tab.title
